...
const mockPlan = {
  ...
  dataAmount: '110GB',
  monthlyFee: '69000',
  description: '기본 데이터 110GB + 속도제한 없음',
  features: '무료 통화 무제한\n무료 문자 무제한\n데이터 소진 후 5Mbps',
  isActive: true
};

export default function PlanEditClient({ planId }: PlanEditClientProps) {
  const router = useRouter();

  // TODO: Replace mockPlan with actual data fetch using planId
  const [formData, setFormData] = useState({ ...mockPlan, id: planId || mockPlan.id });
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">요금제 수정</h1>
        </div>
      </div>
